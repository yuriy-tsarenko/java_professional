package com.java_professional.tsarenko.classwork.lesson11.stream.example3;

import com.java_professional.tsarenko.classwork.lesson11.stream.example1.Product;
    ...
    public static void main(String[] args) {
        ...
        Product productTest = productsList.stream()
                .max((product1, product2) -> {
                    ...
                    System.out.println("price1: " + product1.getPrice());
                    System.out.println("price2: " + product2.getPrice());
