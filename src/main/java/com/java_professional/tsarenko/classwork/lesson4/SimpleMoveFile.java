...
public class SimpleMoveFile {
    public static void main(String[] args) {
        File sourceFile = new File("D:\\IT\\IdeaProjects\\java_professional\\src\\main\\java\\com\\"
                + "java_professional\\tsarenko\\classwork\\lesson4\\SimpleByteArrayInputStream.java");
        File targetFile = new File("D:\\IT\\IdeaProjects\\java_professional\\src\\main\\java\\com\\"
                + "java_professional\\tsarenko\\classwork\\lesson4\\readingFile\\SimpleByteArrayInputStream.java");
